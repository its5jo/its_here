...
class UserServiceTest {
    ...
    @Nested
    @DisplayName("Manager 생성 API 테스트")
    class CreateManagerTest {

        @Test
        @DisplayName("Manager 생성 성공")
        void create_success() {
            // given
            ...
            assertThat(savedUser.getPassword()).isEqualTo("encodedPassword");
            assertThat(savedUser.getNickname()).isEqualTo("매니저");
        ...
        @Test
        @DisplayName("Manager 생성 실패 - Username이 중복되면 예외가 발생")
        ...
        @Test
        @DisplayName("Manager 생성 실패 - MASTER 권한이 아니면 예외가 발생")
        void create_fail_not_master() {
            // given
            UserCreateRequestDto request = new UserCreateRequestDto(
                    "manager",
                    "Password123!",
            ...
            UserEntity manager = UserEntity.create(
                    "manager1",
                    "encodedPassword",
                    "기존매니저",
                    UserRole.MANAGER
